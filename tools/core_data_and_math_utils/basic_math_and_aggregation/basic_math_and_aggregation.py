...
from decimal import Decimal, getcontext, ROUND_CEILING, ROUND_FLOOR, ROUND_HALF_UP
...
def SUM(ctx: Any, values: Union[list[Union[float, int]], list[Decimal], pl.Series, np.ndarray, str, Path]) -> Decimal:
    """
...
def AVERAGE(ctx: Any, values: Union[list[Union[float, int]], list[Decimal], pl.Series, np.ndarray, str, Path]) -> Decimal:
    """
...
def MIN(ctx: Any, values: Union[list[Union[float, int]], list[Decimal], pl.Series, np.ndarray, str, Path]) -> Decimal:
    """
...
def MAX(ctx: Any, values: Union[list[Union[float, int]], list[Decimal], pl.Series, np.ndarray, str, Path]) -> Decimal:
    """
...
def PRODUCT(ctx: Any, values: Union[list[Union[float, int]], list[Decimal], pl.Series, np.ndarray, str, Path]) -> Decimal:
    """
...
def MEDIAN(ctx: Any, values: Union[list[Union[float, int]], list[Decimal], pl.Series, np.ndarray, str, Path]) -> Decimal:
    """
...
def MODE(ctx: Any, values: Union[list[Union[float, int]], list[Decimal], pl.Series, np.ndarray, str, Path]) -> Decimal | list[Decimal]:
    """
...
def PERCENTILE(ctx: Any, values: Union[list[Union[float, int]], list[Decimal], pl.Series, np.ndarray, str, Path], *, percentile_value: float) -> Decimal:
    """
...
def POWER(ctx: Any, values: Union[list[Union[float, int]], list[Decimal], pl.Series, np.ndarray, str, Path], *, power: float | Decimal, output_filename: str | None = None) -> list[Decimal]:
    """
...
def SQRT(ctx: Any, values: Union[list[Union[float, int]], list[Decimal], pl.Series, np.ndarray, str, Path], *, output_filename: str | None = None) -> list[Decimal]:
    """
    ...
    try:
        ...
        raise DataQualityError(
            f"Invalid value in SQRT calculation: {str(e)}",
            "Ensure all values are non-negative numeric values"
        )


def EXP(ctx: Any, values: Union[list[Union[float, int]], list[Decimal], pl.Series, np.ndarray, str, Path], *, output_filename: str | None = None) -> list[Decimal]:
    """
...
def LN(ctx: Any, values: Union[list[Union[float, int]], list[Decimal], pl.Series, np.ndarray, str, Path], *, output_filename: str | None = None) -> list[Decimal]:
    """
    ...
    try:
        ...
        raise DataQualityError(
            f"Invalid value in LN calculation: {str(e)}",
            "Ensure all values are positive numeric values"
        )


def LOG(ctx: Any, values: Union[list[Union[float, int]], list[Decimal], pl.Series, np.ndarray, str, Path], *, base: float | Decimal | None = None, output_filename: str | None = None) -> list[Decimal]:
    """
...
def ABS(ctx: Any, values: Union[list[Union[float, int]], list[Decimal], pl.Series, np.ndarray, str, Path], *, output_filename: str | None = None) -> list[Decimal]:
    """
    ...
    try:
        ...
        raise DataQualityError(
            f"Invalid value in ABS calculation: {str(e)}",
            "Ensure all values are valid numeric values"
        )


def SIGN(ctx: Any, values: Union[list[Union[float, int]], list[Decimal], pl.Series, np.ndarray, str, Path]) -> list[int]:
    """
    ...
    try:
        ...
        raise DataQualityError(
            f"Invalid value in SIGN calculation: {str(e)}",
            "Ensure all values are valid numeric values"
        )


def MOD(ctx: Any, dividends: Union[list[Union[float, int]], list[Decimal], pl.Series, np.ndarray, str, Path], *, divisors: Union[list[Union[float, int]], list[Decimal], pl.Series, np.ndarray, str, Path]) -> list[Decimal]:
    """
        ...
        if isinstance(divisors, (list, np.ndarray, pl.Series)):
            ...
            if len(dividend_series) != len(divisor_series):
                ...
                if len(divisor_series) == 1:
                    ...
                    raise ValidationError("Dividends and divisors must have the same length, or divisors must be a single value")
        else:
...
def ROUND(ctx: Any, values: Union[list[Union[float, int]], list[Decimal], pl.Series, np.ndarray, str, Path], *, num_digits: int) -> list[Decimal]:
    """
...
def ROUNDUP(ctx: Any, values: Union[list[Union[float, int]], list[Decimal], pl.Series, np.ndarray, str, Path], *, num_digits: int) -> list[Decimal]:
    """
...
def ROUNDDOWN(ctx: Any, values: Union[list[Union[float, int]], list[Decimal], pl.Series, np.ndarray, str, Path], *, num_digits: int) -> list[Decimal]:
    """
...
def WEIGHTED_AVERAGE(ctx: Any, values: Union[list[Union[float, int]], list[Decimal], pl.Series, np.ndarray, str, Path], *, weights: Union[list[Union[float, int]], list[Decimal], pl.Series, np.ndarray, str, Path]) -> Decimal:
    """
...
def GEOMETRIC_MEAN(ctx: Any, values: Union[list[Union[float, int]], list[Decimal], pl.Series, np.ndarray, str, Path]) -> Decimal:
    """
    ...
    try:
        ...
        raise DataQualityError(
            f"Invalid values in GEOMETRIC_MEAN: {str(e)}",
            "Ensure all values are positive numbers"
        )


def HARMONIC_MEAN(ctx: Any, values: Union[list[Union[float, int]], list[Decimal], pl.Series, np.ndarray, str, Path]) -> Decimal:
    """
...
def CUMSUM(ctx: Any, values: Union[list[Union[float, int]], list[Decimal], pl.Series, np.ndarray, str, Path], *, output_filename: str | None = None) -> list[Decimal]:
    """
...
def CUMPROD(ctx: Any, values: Union[list[Union[float, int]], list[Decimal], pl.Series, np.ndarray, str, Path], *, output_filename: str | None = None) -> list[Decimal]:
    """
...
def VARIANCE_WEIGHTED(ctx: Any, values: Union[list[Union[float, int]], list[Decimal], pl.Series, np.ndarray, str, Path], *, weights: Union[list[Union[float, int]], list[Decimal], pl.Series, np.ndarray, str, Path]) -> Decimal:
    """
